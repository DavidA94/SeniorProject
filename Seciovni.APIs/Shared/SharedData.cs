        ...
        public static IEnumerable<BindingOptionData> GetBindingOptions(BindingOption option)
        {
            ...
            if (option == BindingOption.BOTH || option == BindingOption.REPEATING)
            {
                ...
                if (option != BindingOption.BOTH)
                {
                    retVal.InsertRange(0, new List<BindingOptionData>
                    {
                        ...
                        new BindingOptionData(MISC_CHARGE, nameof(MiscellaneousFee.Price), MISC_FEE + "." + nameof(MiscellaneousFee.Price), BindingType.Range),
                        ...
                        new BindingOptionData(PAYMENT, nameof(Payment.Amount), PAYMENT + "." + nameof(Payment.Amount), BindingType.Range)
                    });
                }
                ...
                retVal.InsertRange(retVal.Count, new List<BindingOptionData>
                {
                    ...
                    new BindingOptionData(VEHICLE, nameof(VehicleInfo.Year), VEHICLE_INFO + "." + nameof(VehicleInfo.Year), BindingType.Range),
                    ...
                    new BindingOptionData(VEHICLE, nameof(VehicleInfo.Price), VEHICLE_INFO + "." + nameof(VehicleInfo.Price), BindingType.Range),
                });
            }
            if (option == BindingOption.BOTH || option == BindingOption.SINGLE)
            {
                ...
                retVal.InsertRange(0, new List<BindingOptionData>
                {
                    ...
                    new BindingOptionData(INVOICE, "Invoice Number", nameof(Invoice.InvoiceID), BindingType.Range),
                    ...
                    new BindingOptionData(INVOICE, "Tax", nameof(Invoice.TaxAmount), BindingType.Range),
                    new BindingOptionData(INVOICE, "Doc Fee", nameof(Invoice.DocFee), BindingType.Range),
                    new BindingOptionData(INVOICE, "Down Payment", nameof(Invoice.DownPayment), BindingType.Range),
                    new BindingOptionData(INVOICE, "Invoice Total", "Total", BindingType.Range),
                    new BindingOptionData(INVOICE, "Amount Due", "Due", BindingType.Range),
