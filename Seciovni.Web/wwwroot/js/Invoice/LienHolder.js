...
class LienHolder{
    ...
    constructor(lienDialog){
        ...
        document.getElementById("getLienButton").addEventListener('click', this._showBound);
        document.getElementById("closeLienDialog").addEventListener('click', this._hideBound);
